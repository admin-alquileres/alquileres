...
function renderLogin(){
  $("root").innerHTML=`<div class="login-wrap"><div class="login-card">
    <div class="login-logo">${logoSVG(48)}</div>
    <div class="login-title">ECKERDT <span>INMOBILIARIA</span></div>
...
function render(){
  ...
  $("root").innerHTML=`<div class="app">
    <aside class="sidebar">
      <div class="logo-wrap"><div class="logo-row">${logoSVG(30)}<div><div class="logo-brand">ECKERDT <span>INMOBILIARIA</span></div></div></div><div class="logo-sub">Urdinarrain · Entre Ríos</div></div>
